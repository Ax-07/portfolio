    ...
    return (
        <div className="contact">
            ...
            <form action="" className="contact__form">
                ...
                <textarea name="message" id="message" cols="30" rows="10" className="contact__form-input" placeholder="Message*" value={message} onChange={(e) => setMessage(e.target.value)} aria-label="Message"></textarea>
